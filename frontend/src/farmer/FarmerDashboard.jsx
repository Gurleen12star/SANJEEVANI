    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'Inter, sans-serif' }}>
      ...
      <div style={{ maxWidth: '480px', margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          {card(() => navigate('/farmer/scan'), '📸', 'Scan Crop Health', cropScan ? `Last scan: ${cropScan.crop_health_score >= 80 ? 'Good Health' : (cropScan.crop_health_score >= 55 ? 'Medium Health' : 'Poor Health')}` : 'Verify assets using AI computer vision.', '#16a34a')}
